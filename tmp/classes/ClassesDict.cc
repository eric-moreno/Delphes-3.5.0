...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::HectorHit*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("HectorHit", ::HectorHit::Class_Version(), "classes/DelphesClasses.h", 619,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::Candidate*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Candidate", ::Candidate::Class_Version(), "classes/DelphesClasses.h", 643,
...
"external",
"/usr/include/root",
"/afs/cern.ch/user/e/emoreno/foundation/simulation/Delphes-3.5.0/",
nullptr
    };
